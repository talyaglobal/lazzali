...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess('Üyelik kaydınız başarıyla oluşturuldu! E-postanızı kontrol ederek hesabınızı doğrulayın.')
      ...
      if (error.message.includes('already registered')) {
        setError('Bu e-posta adresi ile zaten bir hesap bulunmaktadır.')
      } else {
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-lg shadow-sm p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                VIP üyeliğinizi oluşturun ve özel avantajlardan yararlanın
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <Link href="/auth/login" className="font-medium text-luxury-gold hover:text-luxury-gold/90">
                    Giriş yapın
                  </Link>
                </p>
              </div>
          ...
          <div className="mt-8 bg-luxury-gold/5 border border-luxury-gold/20 rounded-lg p-6">
            <h3 className="font-medium text-luxury-charcoal mb-3">VIP Üyelik ile Kazandıklarınız</h3>
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li className="flex items-center">
                <div className="w-2 h-2 bg-luxury-gold rounded-full mr-3"></div>
                Her alışverişte VIP puan kazanma
              </li>
              <li className="flex items-center">
                <div className="w-2 h-2 bg-luxury-gold rounded-full mr-3"></div>
